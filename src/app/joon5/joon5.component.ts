...
@Component({
  selector: "joon5-component",
  templateUrl: "./joon5.component.html",
  styleUrls: ["./joon5.component.scss"]
})
export class Joon5Component implements OnInit, AfterViewInit {
  myImage:string="https://interstat.info/raudtee/MudelidRaudtee2.gif"
  name = "Angular";
  cx;
