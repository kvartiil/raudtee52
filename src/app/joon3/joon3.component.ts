...
@Component({
  selector: "joon3-component",
  templateUrl: "./joon3.component.html",
  styleUrls: ["./joon3.component.scss"]
})
export class Joon3Component implements OnInit, AfterViewInit {
  myImage:string="https://interstat.info/raudtee/raud3.gif"
  name = "Angular";
  cx;
