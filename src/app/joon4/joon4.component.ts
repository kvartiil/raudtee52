...
@Component({
  selector: "joon4-component",
  templateUrl: "./joon4.component.html",
  styleUrls: ["./joon4.component.scss"]
})
export class Joon4Component implements OnInit, AfterViewInit {
  myImage:string="https://interstat.info/raudtee/MudelidRaudtee.gif"
  name = "Angular";
  cx;
