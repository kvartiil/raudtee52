...
@Component({
  selector: "joon2-component",
  templateUrl: "./joon2.component.html",
  styleUrls: ["./joon2.component.scss"]
})
export class Joon2Component implements OnInit, AfterViewInit {
  myImage:string="https://interstat.info/raudtee/raud2.gif"
  name = "Angular";
  cx;
