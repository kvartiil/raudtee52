...
@Component({
  selector: "joon6-component",
  templateUrl: "./joon6.component.html",
  styleUrls: ["./joon6.component.scss"]
})
export class Joon6Component implements OnInit, AfterViewInit {
  myImage:string="https://interstat.info/raudtee/MudelidRaudtee3.gif"
  name = "Angular";
  cx;
