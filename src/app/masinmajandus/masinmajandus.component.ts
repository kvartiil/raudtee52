 ...
 */
 ...
 @Component({
  selector: 'masinmajandus-component',
  templateUrl: './masinmajandus.component.html',
  styleUrls: ['./masinmajandus.component.scss']
})

 export class MasinmajandusComponent implements OnInit {
// Create layers
...
//  log('\n');
  ...
  localStorage.setItem("ennustusMajandus", JSON.stringify(this.ennustame));
